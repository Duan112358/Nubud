...
public class FeedContract {
	 ...
	 */
	public static final String CONTENT_AUTHORITY = "com.emacs.nubud.provider";

	/**
	 * Base URI. (content://com.emacs.nubud.adapters)
	 */
	...
	public static class Entry implements BaseColumns {
		...
		/**
		 * Atom ID. (Note: Not to be confused with the database primary key,
		 * which is _ID.
		 */
