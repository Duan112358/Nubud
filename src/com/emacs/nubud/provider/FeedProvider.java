package com.emacs.nubud.provider;

import com.emacs.nubud.utils.SelectionBuilder;
...
public class FeedProvider extends ContentProvider{
	...
	static class FeedDatabase extends SQLiteOpenHelper {
		...
		private static final String SQL_CREATE_ENTRIES = "CREATE TABLE "
				...
				+ " INTEGER PRIMARY KEY,"
				+ FeedContract.Entry.COLUMN_NAME_ENTRY_ID + TYPE_TEXT
				+ COMMA_SEP + FeedContract.Entry.COLUMN_NAME_TITLE + TYPE_TEXT
				+ COMMA_SEP + FeedContract.Entry.COLUMN_NAME_LINK + TYPE_TEXT
				+ COMMA_SEP + FeedContract.Entry.COLUMN_NAME_PUBLISHED
				+ TYPE_INTEGER + ")";
